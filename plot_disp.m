function [los_rep]=plot_disp(datafile,tit,stk,ind,strike,dip,length,width)
...
% pu(x_rep,strcat(tit,'\_x'),strike,dip,length,width);
% pu(y_rep,strcat(tit,'\_y'),strike,dip,length,width);
% pu(z_rep,strcat(tit,'\_z'),strike,dip,length,width);
pu(los_rep,strcat(tit,'\_los'),strike,dip,length,width);
